...
public class RegistroProductoFORM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblAgregarProductos.setBackground(new java.awt.Color(19, 70, 134));
        lblAgregarProductos.setFont(new java.awt.Font("Segoe UI Emoji", 1, 24)); // NOI18N
        lblAgregarProductos.setForeground(new java.awt.Color(19, 70, 134));
        lblAgregarProductos.setText("Agregar producto nuevo");
        ...
        btnGuardarProducto.setBackground(new java.awt.Color(19, 70, 134));
        ...
        pnlPrincipalLayout.setHorizontalGroup(
            ...
            .addGroup(pnlPrincipalLayout.createSequentialGroup()
                .addGroup(pnlPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlPrincipalLayout.createSequentialGroup()
                        .addGap(340, 340, 340)
                        .addComponent(btnGuardarProducto, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnAgregarIngredienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarIngredienteActionPerformed
        if (ingredienteSeleccionado == null) {
            javax.swing.JOptionPane.showMessageDialog(this, "Primero busca y selecciona un ingrediente.", "Aviso", javax.swing.JOptionPane.WARNING_MESSAGE);
            return;
        }
        String cantidadStr = txtCantidad.getText().trim();
        if (cantidadStr.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Ingresa la cantidad requerida.", "Aviso", javax.swing.JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try {
            ...
            for (int i = 0; i < modeloTabla.getRowCount(); i++) {
                ...
                if (idExistente.equals(ingredienteSeleccionado.getIdIngrediente())) {
                    javax.swing.JOptionPane.showMessageDialog(this, "Ese ingrediente ya está en la receta.", "Aviso", javax.swing.JOptionPane.WARNING_MESSAGE);
                    return;
                }
            }
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "La cantidad debe ser un número válido mayor a 0.", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btnGuardarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarProductoActionPerformed
        ...
        try {
            ...
            java.util.List<itson.restaurantedtos.DetallesRecetaDTO> listaReceta = new java.util.ArrayList<>();
        ...
        } catch (itson.restaurantenegocio.NegocioException ex) {
